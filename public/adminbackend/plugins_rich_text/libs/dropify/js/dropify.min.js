  ...
  function i(i, t) {
    if (window.File && window.FileReader && window.FileList && window.Blob) {
      var s = {
        ...
        tpl: {
          wrap: '<div class="dropify-wrapper" style="width: 50px; height: 50px;"></div>',
          loader: '<div class="dropify-loader"></div>',
          message:
            '',
          preview:
            '<div class="dropify-preview"><span class="dropify-render"></span><div class="dropify-infos"><div class="dropify-infos-inner"></div></div></div>',
          filename:
            '',
          clearButton:
            '',
