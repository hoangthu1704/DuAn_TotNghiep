					...
					<div class="card">
						<div class="card-body">
							...
							<form id="myForm" method="post" action="{{route('update.brand')}}" enctype="multipart/form-data">
								@csrf
								<input type="hidden" value="{{$detail_brands->id}}" name="id">
								<div class="row mb-3">
									<div class="col-sm-3">
										<h6 class="mb-0">Brand Name</h6>
									</div>
									<div class="form-group col-sm-9 text-secondary">
										<input type="text" value="{{$detail_brands->brand_name}}" name="brand_name" class="form-control" />
									</div>
								</div>
								...
								<div class="row mb-3">
									...
									<div class="col-sm-9 text-secondary">
										<img id="showImage" src="{{asset($detail_brands->brand_image)}}" alt="Admin" style="width:100px; height: 100px;">
									</div>
								</div>
