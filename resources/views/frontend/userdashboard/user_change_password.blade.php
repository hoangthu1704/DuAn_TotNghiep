                    ...
                    <div class="col-md-3">
                        <div class="dashboard-menu">
                            <ul class="nav flex-column" role="tablist">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link active" href="https://digi-poly.id.vn/user/change/password"><i class="fi-rs-user mr-10"></i>Change Password</a>
                                </li>
                            ...
                            <div class="tab-pane fade active show" id="dashboard" role="tabpanel" aria-labelledby="dashboard-tab">
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <form method="post" action="https://digi-poly.id.vn/user/update/password">
